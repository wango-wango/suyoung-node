...
(127, '林', '熊熊', 'bearbear', '$2y$10$eit5KXibqdyKwEjbmuuMo.Gn9EmjaUEesHazj7N2Tb0wNuAPzjA1a', NULL, '2022-05-14', 'VIP', '123@test.com', '0912345678', 'http://localhost:3700/avatar_img/66666.jpg', 9600, NULL, NULL, '', '台北市', '文山區', '指南路二段', '2020-01-08'),
...
--
ALTER TABLE `favlist`
  MODIFY `favlist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=465;
